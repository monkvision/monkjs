...
function ClassicRearLeftMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicRearLeftMask"
      data-name="ClassicRearLeftMask"
...
ClassicRearLeftMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicRearLeftMask;
