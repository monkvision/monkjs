...
function ClassicLateralRearRightMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicLateralRearRightMask"
      data-name="ClassicLateralRearRightMask"
...
ClassicLateralRearRightMask.propTypes = {
...
ClassicLateralRearRightMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicLateralRearRightMask;
