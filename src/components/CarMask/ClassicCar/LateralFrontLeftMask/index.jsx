...
function ClassicLateralFrontLeftMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicLateralFrontLeftMask"
      data-name="ClassicLateralFrontLeftMask"
...
ClassicLateralFrontLeftMask.propTypes = {
...
ClassicLateralFrontLeftMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicLateralFrontLeftMask;
