...
export { default as CameraView } from './CaptureTour'; // Deprecated name
export { default as CameraSimpleView } from './CaptureTour/CameraSimpleView';
export { default as CaptureTour } from './CaptureTour';
