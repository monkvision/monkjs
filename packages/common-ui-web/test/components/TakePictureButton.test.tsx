...
describe('TakePictureButton component', () => {
  ...
  it('should pass the disabled prop down to the button element', () => {
    expectComponentToPassDownOtherPropsToHTMLElement(TakePictureButton, TAKE_PICTURE_BTN_TEST_ID, { disabled: true });
  });
  ...
  it('should pass the style down to the button element', () => {
    expectComponentToPassDownStyleToHTMLElement(TakePictureButton, TAKE_PICTURE_BTN_TEST_ID);
  });
