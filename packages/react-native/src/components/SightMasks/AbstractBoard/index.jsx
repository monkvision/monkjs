...
export default (props) => (
  <svg width="502" height="380" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M351.268 204.815c0 71.856-59.309 130.155-132.53 130.155s-132.53-58.299-132.53-130.155c0-71.857 59.309-130.156 132.53-130.156s132.53 58.299 132.53 130.156Z" stroke="#fff" strokeWidth="3.191" />
    <path d="M328.058 204.962c0 59.264-48.917 107.355-109.318 107.355-60.402 0-109.319-48.091-109.319-107.355S158.338 97.607 218.74 97.607c60.401 0 109.318 48.091 109.318 107.355Z" stroke="#fff" strokeWidth="3.191" />
    <path d="M170.47 182.922c-7.597 7.386-10.375 28.048-10.815 37.455 8.441 19.097 35.521 41.456 48.006 50.248h23.871c12.344-7.069 35.564-31.256 45.631-42.467 5.065-7.28-.175-29.937-3.429-40.356-6.963-6.752-23.563-15.21-30.992-18.595h-38.246c-12.978.316-28.092 9.275-34.026 13.715Z" stroke="#fff" strokeWidth="3.191" />
    <circle cx="220.454" cy="201.782" r="20.033" stroke="#fff" strokeWidth="3.191" />
    <path d="M160.84 171.185a22.319 22.319 0 0 1-4.483-13.452c0-12.383 10.038-22.421 22.421-22.421 12.382 0 22.42 10.038 22.42 22.421 0 4.583-1.376 8.846-3.737 12.397m87.307 3.956a22.313 22.313 0 0 0 3.736-12.397c0-12.382-10.037-22.42-22.42-22.42-12.382 0-22.42 10.038-22.42 22.42 0 3.138.645 6.125 1.809 8.836" stroke="#fff" strokeWidth="3.191" />
    ...
    <path d="m58.502 0 15.43 90.208c.396 1.275 1.61 3.72 3.297 3.297m199.805 147.841c10.462 3.341 33.34 10.076 41.147 10.287" stroke="#fff" strokeWidth="3.191" />
    <rect x="364.158" y="128.678" width="131.938" height="71.902" rx="4.735" transform="rotate(5.282 364.158 128.678)" stroke="#fff" strokeWidth="3.191" />
  </svg>
);
