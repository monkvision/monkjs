...
function ClassicLateralFrontRightMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicLateralFrontRightMask"
      data-name="ClassicLateralFrontRightMask"
...
ClassicLateralFrontRightMask.propTypes = {
...
ClassicLateralFrontRightMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicLateralFrontRightMask;
