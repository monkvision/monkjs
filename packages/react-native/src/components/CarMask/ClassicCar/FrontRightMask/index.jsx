...
function ClassicFrontRightMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicFrontRightMask"
      data-name="ClassicFrontRightMask"
...
ClassicFrontRightMask.propTypes = {
...
ClassicFrontRightMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicFrontRightMask;
