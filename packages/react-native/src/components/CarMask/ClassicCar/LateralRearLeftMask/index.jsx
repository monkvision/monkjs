...
function ClassicLateralRearLeftMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicLateralRearLeftMask"
      data-name="ClassicLateralRearLeftMask"
...
ClassicLateralRearLeftMask.propTypes = {
...
ClassicLateralRearLeftMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicLateralRearLeftMask;
