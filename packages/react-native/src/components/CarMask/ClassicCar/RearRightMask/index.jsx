...
function ClassicRearRightMask({ color, style, styleProps }) {
  // eslint-disable-next-line no-param-reassign
  styleProps.cls3.stroke = color;

  return (
    <Svg
      id="ClassicRearRightMask"
      data-name="ClassicRearRightMask"
...
ClassicRearRightMask.propTypes = {
...
ClassicRearRightMask.defaultProps = {
  color: '#000',
  style: {},
  styleProps: {
    cls1: {
...
export default ClassicRearRightMask;
