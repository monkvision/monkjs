...
export const useHandlers = ({
  ...
  const startUploadAsync = useStartUploadAsync({ inspectionId, sights, uploads, mapTasksToSights, task });
...
export const useMixedStates = ({ state, sights, ids }) => {
  ...
  const hasAllRejected = useMemo(() => state.uploadIdsWithError.length === sights.state.tour.length,
